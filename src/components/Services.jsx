  ...
  return (
    <div 
      ...
      className={`w-72 sm:w-80 rounded-[2rem] p-2 relative flex flex-col items-center hover:scale-[1.02] transition-all duration-700 z-10 ${className} ${
        isActive ? 'bg-[#ff2a2a] border-red-400 shadow-[0_20px_50px_rgba(255,42,42,0.4)]' : 'bg-[#111] border border-white/5 shadow-[0_15px_40px_rgba(0,0,0,0.06)] hover:shadow-[0_20px_50px_rgba(0,0,0,0.12)]'
      }`}
    >
      {/* The hole punch */}
      <div className="w-5 h-5 bg-gradient-to-br from-neutral-700 to-neutral-900 rounded-full shadow-[inset_0_2px_4px_rgba(0,0,0,0.5)] absolute top-4 border border-neutral-800 z-10 flex items-center justify-center">
        <div className="w-2 h-2 bg-neutral-950 rounded-full opacity-20"></div>
      </div>
      
      {/* Inner container */}
      <div className={`w-full h-full rounded-[1.5rem] mt-8 p-8 flex flex-col min-h-[220px] transition-colors duration-700 ${
        isActive ? 'bg-red-700/50' : 'bg-[#1a1a1a]'
      }`}>
        <span className={`text-xl font-bold mb-2 font-serif italic transition-colors duration-700 ${
          isActive ? 'text-red-200' : 'text-neutral-500'
        }`}>{number}</span>
      ...
      <div className="max-w-6xl mx-auto relative md:h-[1350px]">
        ...
        <div data-aos="fade-up" className="md:absolute top-10 left-0 md:w-[450px] z-20 mb-16 md:mb-0">
          ...
          <p className="text-white/60 text-base md:text-lg max-w-sm font-medium leading-relaxed">
            I follow a structured, collaborative, and technical approach to turn ideas into robust, intelligent software applications.
          </p>
        </div>
        ...
        <div className="flex flex-col gap-8 md:gap-12 items-center md:block relative z-10 w-full pt-4 md:pt-0 pb-12 md:pb-0">
          ...
          <TagCard 
            number="01"
            title="Define"
            text="I start by clarifying objectives, defining core user needs, and establishing architecture constraints to secure a solid start."
          ...
          <TagCard 
            number="02"
            title="Design"
            text="Creating clean UI schema, system maps, and database schemas ensuring optimal workflow, accessibility, and backend efficiency."
          ...
          <TagCard 
            number="03"
            title="Build"
            text="Writing robust frontend layout and backend scripts utilizing JavaScript, React, Python, SQL, and AI model configurations."
          ...
          <TagCard 
            number="04"
            title="Launch"
            text="Integrating features, executing testing, and conducting deployments to cloud providers alongside continuous optimizations."
          ...
          <div 
            data-aos="fade-in" 
            data-aos-delay="600"
            className="hidden md:block absolute top-[1250px] left-[60%] font-mono text-xl text-neutral-500 uppercase tracking-widest rotate-6"
          >
